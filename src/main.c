...
void menu_admin(FILE *rep)
{
	...
	do
	{
		do
		{
			...
			printf("4-Modifier m'l'abonnement d'un client dans la bdd\n");
		...
		switch (choix)
		{
			...
			case 5 : printf(" ici appel de la fonction Ajouter un mot clé et sa reponse dans la bdd mot clé\n");
				 break;
			case 6 : printf(" ici appel de la fonction Afficher les mots clés et leurs reponses\n");//saisie_mail(fichier);
				 break;
			case 7 : printf(" ici appel de la fonction Rechercher un mot clé et sa reponse\n");
				 break;
			case 8 : printf(" ici appel de la fonction Supprimer un mot clé et sa reponse\n");//saisie_mail(fichier);
				 break;
